...
namespace ACK
{
    public partial class Form1 : Form
    {
        ...
        string connectionStr = @"Server=localhost;Port=3306;Database=ack_test;Uid=root;Pwd=1234;";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (IDbConnection connection = new MySqlConnection(connectionStr))
            {
                ...
                var reader = connection.Query<StudentChanged>(readQuery);

                this.studentBindingSource.DataSource = reader;
